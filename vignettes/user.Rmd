...
To make it easier to identify of all packages in the
many packages universe, we have developed the `get_packages()` function.
The function lists the many packages available and allow users to downlaod them.
...
The `consolidate()` function which facilitates consolidating a set of datasets, or a database,
...
Users can even specify how conflictis for different variables should be 'resolved':

...
Multilateral + Protocol | 19920817E2_20070817A | uID,type(number)_linkage
...
(20050205) and the type (A). A multilateral treaty that is not an agreement will have this qID format: "19920817E2_20070817". This represents the signature date of the amendment (19920817), the type (E), the number of amendment (2) and the linkage number (20070817A) which is the qID of the "mother" treaty. 

**Type** | **Pasting** | **Pasting**
--- | --- |--- 
Known treaties | 	UNCLOS19821210 | abbreviation, uID
Amendment of known treaties | 19900316E_MARPOL19731102| uID,type(number), abbreviation, uID
...
protocols or amendments of the known treaties will have this qID format: "19890317E2_MARPOL19731102". It indicates the known abbreviation (MARPOL), the signature date of this specific amendment (19890317), the type of treaty (E), its number (2) and the signature date of the "mother" treaty (19731102).

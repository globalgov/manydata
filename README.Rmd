...
`{manydata}` is a portal to other 'many packages' that help researchers download and manipulate related data across various issue-domains of global governance, and beyond.

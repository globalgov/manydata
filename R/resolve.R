...
#'   
#'   var <- dplyr::if_else(stringr::str_detect(var, "^[:digit:]{4}-[:digit:]{2}-[:digit:]{2}:[:digit:]{4}-[:digit:]{2}-[:digit:]{2}$"), 
#'                         as.character(resolve_dates(var, "min")), as.character(var)) 
#'     
...
#'   
#'   var <- dplyr::if_else(stringr::str_detect(var, "^[:digit:]{4}-[:digit:]{2}-[:digit:]{2}:[:digit:]{4}-[:digit:]{2}-[:digit:]{2}$"), 
#'                         as.character(resolve_dates(var, "max")), as.character(var)) 
#'   
...
#'   
#'   var <- dplyr::if_else(stringr::str_detect(var, "^[:digit:]{4}-[:digit:]{2}-[:digit:]{2}:[:digit:]{4}-[:digit:]{2}-[:digit:]{2}$"), 
#'                         as.character(resolve_dates(var, "mean")), as.character(var)) 
#'   
#'   
...
#'   
#'   var <- dplyr::if_else(stringr::str_detect(var, "^[:digit:]{4}-[:digit:]{2}-[:digit:]{2}:[:digit:]{4}-[:digit:]{2}-[:digit:]{2}$"), 
#'                         as.character(resolve_dates(var)), as.character(var)) 
#'   

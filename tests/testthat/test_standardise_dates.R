...
#   # expect_match(as.character(standardise_dates("2010-00-00")), "1111-11-11") # tofix
# })
...
test_that("standardise_dates() treats historical dates correctly",{
  ...
  # expect_match(as.character(min(standardise_dates("1712 AD")[[1]])), "1712-01-01") #Date range tofix
  # expect_match(as.character(min(standardise_dates("12 AD")[[1]])), "0012-01-01") #Date range tofix
  # expect_match(as.character(min(standardise_dates("12")[[1]])), "0012-01-01") #Date range tofix
  # expect_match(as.character(min(standardise_dates("1712 AD")[[1]])), "1712-01-01") #Date range tofix
...
test_that("standardise_dates() treats inconsistent date format correctly", {
 dates6 <- data.frame(date = c("4/30/1990", "NA", "2010-12-30", "Obsolete?", "2010-00-00", "2599-01-01"))
 expect_equal(as.character(standardise_dates(dates6$date)), c("1990-04-30", NA, "2010-12-30", NA, NA, "9999-12-31"))
})

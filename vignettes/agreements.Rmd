...
If we randomly create a variable with 200 values and use it to find duplicates, the AUC scores margianlly. The ROC plaot illustrates how some true positives as well as a few false positives are matched.

...
dates <- sample(dates, 200)

qData::code_agreements(titles, dates)
```
...
Parties to an agreement are extracted from titles.
...
The type of treaty s extracted.
...
The date of the treaty is condensed to form a unique ID number. 
...
Once added together the information forms a qID which is more authoritative, comprehensible, succinct and intelligible then other naming conventions.  

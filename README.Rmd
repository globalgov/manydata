...
It is a package both for users of this data as well as for data owners and developers.
...
For developers, `{qData}` provides the necessary tools to put their data in the hands of users.
...
Please see [the website](https://globalgov.github.io/qData/) for more information about how to use `{qData}` for both developers and users.
